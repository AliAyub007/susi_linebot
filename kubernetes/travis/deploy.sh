...
openssl aes-256-cbc -K $encrypted_64ad57c57e0f_key -iv $encrypted_64ad57c57e0f_iv -in ./kubernetes/travis/susi-telegrambot-85cf0ec296e9.json.enc -out susi-telegrambot-85cf0ec296e9.json -d
mkdir -p lib
